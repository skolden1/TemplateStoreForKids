...
namespace MallarEmelieMVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            IEmailSender emailSender)
        {
            ...
            _emailStore = (IUserEmailStore<IdentityUserTable>)GetEmailStore();
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "Lösenordet måste vara mellan {2} och {1} tecken.", MinimumLength = 4)]
